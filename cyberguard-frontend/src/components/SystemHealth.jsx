    ...
    <div className="health-grid grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
      <div className="health-card">
        ...
        <div>
          ...
          <p className="text-sm font-bold text-white">{health ? `${health.uptime_seconds}s up` : 'Checking...'}</p>
        </div>
      </div>
      <div className="health-card">
      ...
      <div className="health-card">
        ...
        <div>
          ...
          <p className="text-sm font-bold text-white">{health ? `${health.events_stored} events` : 'Checking...'}</p>
        </div>
      </div>
      <div className="health-card">
        ...
        <div>
          ...
          <p className="text-sm font-bold text-white">{health?.status === 'healthy' ? 'Healthy' : 'Checking...'}</p>
        </div>
      </div>
    </div>
  );
